...
#Height_above = 3
Height_above = 0.001  #20k
Height_above = 0.00001
##########################
# ----- Parameters ----- #
##########################
...
N_dist = 'none'
Cluster = 6
N_min = 31                  # Minimum PP per agg (this is used if N_variable = False)
N_min = 100                  # Minimum PP per agg (this is used if N_variable = False)
...
r_dist = 'lognorm'
rmin = 1.5                # Minimum PP diameter in nm
...
analysis_height = 0.1# 0.9       # This relative height is used to evaluate porosity and percolation
...
output_folder = './case_studies' + experiment +'/results'
